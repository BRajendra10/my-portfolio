  ...
  return (
    <div className="w-full h-screen flex justify-center items-center bg-stone-50">
      <nav className="w-full md:w-[44rem] h-screen md:h-[25rem] grid grid-cols-2 md:grid-cols-3 border border-stone-500">
        <NavLink className="flex justify-center items-center border text-2xl text-stone-700 border-stone-700 hover:text-stone-950" to={"/aboutMe"}>about me</NavLink>
        ...
        <NavLink className="flex justify-center items-center border text-2xl text-stone-700 border-stone-700 hover:text-stone-950" to={"/resume"}>resume</NavLink>
